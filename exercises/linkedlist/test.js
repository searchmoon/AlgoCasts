...
describe("Find", () => {
  test("returns true when the value exists in the list", () => {
    ...
    expect(l.find(20)).toEqual(true);
    expect(l.find(10)).toEqual(true);
  });

  test("returns false when the value does not exist in the list", () => {
    const l = new List();
    l.insertFirst(10);
    l.insertFirst(20);
    l.insertFirst(30);

    expect(l.find(40)).toEqual(false);
    expect(l.find(5)).toEqual(false);
  });

  test("returns false on an empty list", () => {
    const l = new List();
    expect(l.find(10)).toEqual(false);
  });
});

describe("Delete", () => {
  test("removes the node with the specified value from the list", () => {
    const l = new List();
    l.insertFirst(10);
    l.insertFirst(20);
    l.insertFirst(30);
    ...
    expect(l.delete(20)).toEqual(true);
    expect(l.size()).toEqual(2);
    expect(l.find(20)).toEqual(false);
  });

  test("returns false if the value is not found in the list", () => {
    const l = new List();
    l.insertFirst(10);
    l.insertFirst(20);
    l.insertFirst(30);

    expect(l.delete(40)).toEqual(false);
  });

  test("does not modify the list if it is empty", () => {
    const l = new List();
    expect(l.delete(10)).toEqual(false);
    expect(l.size()).toEqual(0);
  });

  test("removes the head node when the value exists in the head node", () => {
    const l = new List();
    l.insertFirst(10);
    l.insertFirst(20);
